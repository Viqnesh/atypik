 ...
 */
final class Version20201120102304 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD type_habitat_id INT NOT NULL, ADD title VARCHAR(45) NOT NULL, DROP statut');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD statut VARCHAR(25) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP type_habitat_id, DROP title');
